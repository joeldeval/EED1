			...
			<div id="main">
				...
				<div class="wrapper">
					...
					<div id="page-content">
						...
						<!-- Aqui va el titulo y parrafo del contenido --><div id= "tabla">
...
<td><font face="verdana"><b>MESA</b></font></td>
  ...
  $query ="SELECT Nombre,Codigo,Ap_Paterno,Ap_Materno,urnas.voto " .
      "FROM estudiante,sede,urnas WHERE Sede.id=id_Sede AND Sede.id=1 AND Urnas.id_Estudiante=estudiante.id AND urnas.voto=1";
